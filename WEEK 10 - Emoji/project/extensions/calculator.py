...
class Calculator(commands.Cog):
    def __init__(self, discord_client: commands.Bot):
        ...
        # Command for the calculator
        @self.client.hybrid_command(name="calculator", description="Sends an interactive calculator")
        async def calculator(ctx: commands.Context):
            await ctx.send("```Begin Calculating```", view=Buttons())
